...
public class Queue<T>
{
    ...
    public class Node
    {
        ...
        /// <summary>
        /// Gets or sets next node in the queue.
        /// </summary>
        ...
        /// </summary>
        /// <param name="value">The initial value of node.</param>
        public Node(T value)
        {
            Value = value;
            Next = null;
    ...
    /// <summary>
    /// Gets or sets head node of the queue.
    /// </summary>
    public Node Head { get; set; } = null;

    /// <summary>
    /// Gets or sets tail node of the queue.
    /// </summary>
